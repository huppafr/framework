...
from framework.cmd_mappers.LinuxCmdResult import LinuxCmdResult
...
class SshConnect:
    ...
    def exec(self, cmd: str, ignore_stderr: bool = True) -> LinuxCmdResult:
        """
        ...
        Returns:
            LinuxCmdResult: An instance of LinuxCmdResult containing the command output, exit status, and server IP address.
        """
        ...
        return LinuxCmdResult(cmd, cmd_output, exit_status, self.ip_addr)
